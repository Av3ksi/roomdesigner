...
/**
 * The freemium paywall — shown once the free AI room generation is used up.
 * No real payment integration yet (that's a separate, later phase); this is
 * just the gate and the UI state the product needs to exist first.
 */
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
      ...
      <div className="card relative w-full max-w-sm animate-fade-in p-6 text-center">
        ...
        <h2 className="font-display text-xl">Upgrade to Pro</h2>
        ...
        <button
          onClick={onClose}
          className="mt-6 w-full rounded-full bg-brass py-2.5 text-sm font-semibold text-ink transition hover:bg-brass-bright"
        >
          Upgrade to Pro
        </button>
