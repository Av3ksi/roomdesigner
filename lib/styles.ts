...
export const STYLES: DesignStyle[] = [
  ...
  },
  {
    id: "gaming",
    name: "LED Gaming",
    tagline: "Blackout walls, RGB wash, built for 2am",
    description:
      "Matte near-black surfaces that kill screen glare, one cool RGB wash across the back wall and a warm pool of light at the desk. Comfort first, spectacle second.",
    tags: ["RGB wash", "Blackout", "Desk-first"],
    palette: ["#0E0F13", "#1B1F2A", "#7C3AED", "#22D3EE"],
    budgetBand: "CHF 2.4k – 6.5k",
    spec: {
      wall: "#15171E",
      wallAccent: "#1E2331",
      panel: "none",
      ...
      sofa: "#242936",
      sofaShadow: "#14161D",
      cushions: ["#7C3AED", "#22D3EE", "#0E0F13"],
      wood: "#3A4050",
      metal: "#8A90A0",
      lampGlow: "#9E7BFF",
      // Cool and dim rather than daylight: these rooms are shot after dark,
      // which is when the RGB actually reads as anything.
      windowLight: "#1A2430",
      art: "geo",
      artColors: ["#7C3AED", "#22D3EE"],
      plant: true,
      pendant: false,
      warmth: 0.15,
    },
